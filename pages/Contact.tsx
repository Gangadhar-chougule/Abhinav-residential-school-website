    ...
    <Layout>
      <section className="section-spacing">
        <div className="section-container max-w-3xl">
          <h1 className="heading-display text-center mb-4">संपर्क करा</h1>
          <p className="body-large text-center max-w-2xl mx-auto mb-16">
            For admissions, information, or any inquiries — reach out to us via phone or WhatsApp.
          </p>
          ...
          <div className="border border-border rounded-md p-8 mb-12">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="heading-sub mb-2">School Address</h2>
          ...
          {/* Contact Cards */}
          <h2 className="heading-section mb-8">संपर्काकरीता</h2>
          ...
          <div className="bg-secondary rounded-md p-8 text-center">
            ...
            <h3 className="heading-sub mb-2">Visit or Call Us</h3>
            <p className="body-text">
              Our school provides all services and facilities free of cost. Feel free to contact any of the numbers above for admissions and inquiries.
            </p>
          </div>
        </div>
      </section>
