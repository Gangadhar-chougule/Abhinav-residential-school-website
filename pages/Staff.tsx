...
import staffGroup from "@/assets/staff-group.png";
    ...
    <Layout>
      <section className="section-spacing">
        <div className="section-container">
          <h1 className="heading-display text-center mb-4">सेवकवृंद</h1>
          <p className="body-large text-center max-w-2xl mx-auto mb-12">
            Our dedicated team of professionals committed to the well-being and education of every student.
          </p>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-primary">
                  <th className="text-left py-3 px-4 font-heading text-lg font-semibold text-foreground">अ.क्र</th>
                  <th className="text-left py-3 px-4 font-heading text-lg font-semibold text-foreground">कर्मचारी नाव</th>
                  <th className="text-left py-3 px-4 font-heading text-lg font-semibold text-foreground">पद नाम</th>
                  <th className="text-left py-3 px-4 font-heading text-lg font-semibold text-foreground">मोबाईल</th>
                </tr>
              </thead>
              <tbody>
